(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('dayjs'), require('body-scroll-lock')) :
  typeof define === 'function' && define.amd ? define(['exports', 'dayjs', 'body-scroll-lock'], factory) :
  (global = global || self, factory(global.VueDatePicker = {}, global.dayjs, global.bodyScrollLock));
}(this, function (exports, dayjs, bodyScrollLock) { 'use strict';
  ...
  __vue_render__$4._withStripped = true;
    ...
    const __vue_inject_styles__$4 = function (inject) {
      if (!inject) return
      inject("data-v-79905d6e_0", { source: "/*\n  Media Query mixin\n  @example scss\n\n  @include mq($from: mobile) {\n    color: red;\n  }\n  @include mq($to: tablet) {\n    color: blue;\n  }\n  @include mq(mobile, tablet) {\n    color: green;\n  }\n  @include mq($from: tablet, $and: '(orientation: landscape)') {\n    color: teal;\n  }\n*/\n.datepicker-controls__label button[data-v-79905d6e] {\n  border: none;\n  margin: 0;\n  padding: 0;\n  width: auto;\n  overflow: visible;\n  background: transparent;\n  /* inherit font & color from ancestor */\n  color: inherit;\n  font: inherit;\n  /* Normalize `line-height`. Cannot be changed from `normal` in Firefox 4+. */\n  line-height: normal;\n  /* Corrects font smoothing for webkit */\n  -webkit-font-smoothing: inherit;\n  -moz-osx-font-smoothing: inherit;\n  /* Corrects inability to style clickable `input` types in iOS */\n  -webkit-appearance: none;\n}\n.datepicker-controls__label button[data-v-79905d6e]:focus, .datepicker-controls__label button[data-v-79905d6e]:active {\n    outline: 0;\n    box-shadow: 0;\n}\n.datepicker-controls__label button[type=\"button\"][data-v-79905d6e], .datepicker-controls__label button[type=\"reset\"][data-v-79905d6e], .datepicker-controls__label button[type=\"submit\"][data-v-79905d6e], .datepicker-controls__label button[role=\"button\"][data-v-79905d6e] {\n    cursor: pointer;\n}\n.slide-h-next-leave-active[data-v-79905d6e],\n.slide-h-next-enter-active[data-v-79905d6e],\n.slide-h-prev-leave-active[data-v-79905d6e],\n.slide-h-prev-enter-active[data-v-79905d6e] {\n  position: absolute;\n  transition: transform .3s, opacity .3s;\n}\n.slide-h-next-enter[data-v-79905d6e], .slide-h-prev-leave-to[data-v-79905d6e] {\n  transform: translateX(100%);\n  opacity: 0;\n}\n.slide-h-next-leave-to[data-v-79905d6e], .slide-h-prev-enter[data-v-79905d6e] {\n  transform: translateX(-100%);\n  opacity: 0;\n}\n.slide-v-next-leave-active[data-v-79905d6e],\n.slide-v-next-enter-active[data-v-79905d6e],\n.slide-v-prev-leave-active[data-v-79905d6e],\n.slide-v-prev-enter-active[data-v-79905d6e] {\n  position: absolute;\n  transition: transform .3s, opacity .3s;\n}\n.slide-v-next-enter[data-v-79905d6e], .slide-v-prev-leave-to[data-v-79905d6e] {\n  transform: translateY(100%);\n  opacity: 0;\n}\n.slide-v-next-leave-to[data-v-79905d6e], .slide-v-prev-enter[data-v-79905d6e] {\n  transform: translateY(-100%);\n  opacity: 0;\n}\n.yearMonth-leave-active[data-v-79905d6e], .yearMonth-enter-active[data-v-79905d6e] {\n  position: absolute;\n  transition: opacity .3s;\n}\n.yearMonth-enter[data-v-79905d6e], .yearMonth-leave-to[data-v-79905d6e] {\n  opacity: 0;\n}\n.datepicker-controls[data-v-79905d6e] {\n  position: relative;\n  display: flex;\n  height: 48px;\n  text-align: center;\n  position: relative;\n  width: 100%;\n}\n@media only screen and (min-width: 768px) {\n.datepicker-controls[data-v-79905d6e] {\n      height: 56px;\n}\n}\n.datepicker-controls__wrapper[data-v-79905d6e] {\n    position: relative;\n    overflow: hidden;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    flex: 1;\n}\n.datepicker-controls__month[data-v-79905d6e], .datepicker-controls__year[data-v-79905d6e] {\n    position: relative;\n    display: flex;\n    flex: 1;\n    align-items: center;\n}\n.datepicker-controls__month[data-v-79905d6e] {\n    justify-content: flex-end;\n}\n.datepicker-controls__year[data-v-79905d6e] {\n    justify-content: flex-start;\n}\n.datepicker-controls__year.datepicker-controls__year--center[data-v-79905d6e] {\n      justify-content: center;\n}\n.datepicker-controls__label[data-v-79905d6e] {\n    padding: 8px 4px;\n}\n.datepicker-controls__label button[data-v-79905d6e] {\n      position: relative;\n      display: flex;\n      font-size: 15px;\n      font-weight: 500;\n      line-height: 15px;\n      padding: 0;\n      border: none;\n      outline: none;\n}\n.datepicker-controls__label button[data-v-79905d6e]:disabled, .datepicker-controls__label button[disabled][data-v-79905d6e] {\n        cursor: default;\n        color: rgba(0, 0, 0, 0.26);\n}\n.datepicker-controls button.datepicker-controls__prev[data-v-79905d6e],\n  .datepicker-controls button.datepicker-controls__next[data-v-79905d6e] {\n    position: relative;\n    flex: 0 0 40px;\n    height: 48px;\n    width: 48px;\n    padding: 0 8px 0 16px;\n    border: none;\n    outline: none;\n    background-color: transparent;\n    user-select: none;\n    cursor: pointer;\n}\n@media only screen and (min-width: 768px) {\n.datepicker-controls button.datepicker-controls__prev[data-v-79905d6e],\n      .datepicker-controls button.datepicker-controls__next[data-v-79905d6e] {\n        height: 56px;\n        width: 56px;\n}\n}\n.datepicker-controls button.datepicker-controls__prev[data-v-79905d6e]:disabled, .datepicker-controls button.datepicker-controls__prev[disabled][data-v-79905d6e],\n    .datepicker-controls button.datepicker-controls__next[data-v-79905d6e]:disabled,\n    .datepicker-controls button.datepicker-controls__next[disabled][data-v-79905d6e] {\n      cursor: default;\n}\n.datepicker-controls button.datepicker-controls__prev:disabled svg[data-v-79905d6e], .datepicker-controls button.datepicker-controls__prev[disabled] svg[data-v-79905d6e],\n      .datepicker-controls button.datepicker-controls__next:disabled svg[data-v-79905d6e],\n      .datepicker-controls button.datepicker-controls__next[disabled] svg[data-v-79905d6e] {\n        fill: rgba(0, 0, 0, 0.26);\n}\n.datepicker-controls button.datepicker-controls__next[data-v-79905d6e] {\n    padding: 0 16px 0 8px;\n}\n.datepicker-controls svg[data-v-79905d6e] {\n    width: 24px;\n    height: 24px;\n    fill: rgba(0, 0, 0, 0.87);\n    vertical-align: middle;\n}\n\n/*# sourceMappingURL=DatePickerControls.vue.map */", map: {"version":3,"sources":["DatePickerControls.vue","/Users/stan/Web/Github/vue-datepicker/src/components/datepicker/DatePickerControls.vue"],"names":[],"mappings":"AAAA;;;;;;;;;;;;;;;;CAgBC;ACwID;EDtIE,YAAY;EACZ,SAAS;EACT,UAAU;EACV,WAAW;EACX,iBAAiB;EACjB,uBAAuB;EACvB,uCAAuC;EACvC,cAAc;EACd,aAAa;EACb,4EAA4E;EC+E9E,mBAAA;EAEA,uCAAA;EACA,+BAAA;ED9EE,gCAAgC;ECiFlC,+DAAA;EACA,wBAAA;AAAA;AAEA;IAEA,UAAA;IDjFI,aAAa;AAAE;ACqFnB;IAIA,eAAA;AAAA;ADrFA;;;;EAIE,kBAAkB;EAClB,sCAAsC;AAAE;AAE1C;EACE,2BAA2B;EAC3B,UAAU;AAAE;AAEd;EACE,4BAA4B;EAC5B,UAAU;AAAE;AAEd;;;;EAIE,kBAAkB;EAClB,sCAAsC;AAAE;AAE1C;EACE,2BAA2B;EAC3B,UAAU;AAAE;AAEd;EACE,4BAA4B;EAC5B,UAAU;AAAE;AAEd;EACE,kBAAkB;EAClB,uBAAuB;AAAE;AAE3B;EACE,UAAU;AAAE;ACoCd;EACA,kBAAA;EACA,aAAA;EACA,YAAA;EACA,kBAAA;EACA,kBAAA;EACA,WAAA;AAAA;ADjCE;AC2BF;MASA,YAAA;AAAA;AA2FA;AAxFA;IACA,kBAAA;IACA,gBAAA;IACA,aAAA;IACA,uBAAA;IACA,mBAAA;IACA,OAAA;AAAA;AAGA;IAEA,kBAAA;IACA,aAAA;IACA,OAAA;IACA,mBAAA;AAAA;AAGA;IACA,yBAAA;AAAA;AAGA;IACA,2BAAA;AAAA;AADA;MAIA,uBAAA;AAAA;AAIA;IACA,gBAAA;AAAA;AADA;MAKA,kBAAA;MACA,aAAA;MACA,eAAA;MACA,gBAAA;MACA,iBAAA;MACA,UAAA;MACA,YAAA;MACA,aAAA;AAAA;AAZA;QAgBA,eAAA;QACA,0BAAA;AAAA;AA1DA;;IAiEA,kBAAA;IACA,cAAA;IACA,YAAA;IACA,WAAA;IACA,qBAAA;IACA,YAAA;IACA,aAAA;IACA,6BAAA;IACA,iBAAA;IACA,eAAA;AAAA;ADtDI;ACpBJ;;QA6EA,YAAA;QACA,WAAA;AAAA;AAUA;AAxFA;;;MAsFA,eAAA;AAAA;AAtFA;;;QAoFA,yBAAA;AAAA;AApFA;IA2FA,qBAAA;AAAA;AA3FA;IA+FA,WAAA;IACA,YAAA;IACA,yBAAA;IACA,sBAAA;AAAA;;ADzDA,iDAAiD","file":"DatePickerControls.vue","sourcesContent":["/*\n  Media Query mixin\n  @example scss\n\n  @include mq($from: mobile) {\n    color: red;\n  }\n  @include mq($to: tablet) {\n    color: blue;\n  }\n  @include mq(mobile, tablet) {\n    color: green;\n  }\n  @include mq($from: tablet, $and: '(orientation: landscape)') {\n    color: teal;\n  }\n*/\n.datepicker-controls__label button {\n  border: none;\n  margin: 0;\n  padding: 0;\n  width: auto;\n  overflow: visible;\n  background: transparent;\n  /* inherit font & color from ancestor */\n  color: inherit;\n  font: inherit;\n  /* Normalize `line-height`. Cannot be changed from `normal` in Firefox 4+. */\n  line-height: normal;\n  /* Corrects font smoothing for webkit */\n  -webkit-font-smoothing: inherit;\n  -moz-osx-font-smoothing: inherit;\n  /* Corrects inability to style clickable `input` types in iOS */\n  -webkit-appearance: none; }\n  .datepicker-controls__label button:focus, .datepicker-controls__label button:active {\n    outline: 0;\n    box-shadow: 0; }\n  .datepicker-controls__label button[type=\"button\"], .datepicker-controls__label button[type=\"reset\"], .datepicker-controls__label button[type=\"submit\"], .datepicker-controls__label button[role=\"button\"] {\n    cursor: pointer; }\n\n.slide-h-next-leave-active,\n.slide-h-next-enter-active,\n.slide-h-prev-leave-active,\n.slide-h-prev-enter-active {\n  position: absolute;\n  transition: transform .3s, opacity .3s; }\n\n.slide-h-next-enter, .slide-h-prev-leave-to {\n  transform: translateX(100%);\n  opacity: 0; }\n\n.slide-h-next-leave-to, .slide-h-prev-enter {\n  transform: translateX(-100%);\n  opacity: 0; }\n\n.slide-v-next-leave-active,\n.slide-v-next-enter-active,\n.slide-v-prev-leave-active,\n.slide-v-prev-enter-active {\n  position: absolute;\n  transition: transform .3s, opacity .3s; }\n\n.slide-v-next-enter, .slide-v-prev-leave-to {\n  transform: translateY(100%);\n  opacity: 0; }\n\n.slide-v-next-leave-to, .slide-v-prev-enter {\n  transform: translateY(-100%);\n  opacity: 0; }\n\n.yearMonth-leave-active, .yearMonth-enter-active {\n  position: absolute;\n  transition: opacity .3s; }\n\n.yearMonth-enter, .yearMonth-leave-to {\n  opacity: 0; }\n\n.datepicker-controls {\n  position: relative;\n  display: flex;\n  height: 48px;\n  text-align: center;\n  position: relative;\n  width: 100%; }\n  @media only screen and (min-width: 768px) {\n    .datepicker-controls {\n      height: 56px; } }\n  .datepicker-controls__wrapper {\n    position: relative;\n    overflow: hidden;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    flex: 1; }\n  .datepicker-controls__month, .datepicker-controls__year {\n    position: relative;\n    display: flex;\n    flex: 1;\n    align-items: center; }\n  .datepicker-controls__month {\n    justify-content: flex-end; }\n  .datepicker-controls__year {\n    justify-content: flex-start; }\n    .datepicker-controls__year.datepicker-controls__year--center {\n      justify-content: center; }\n  .datepicker-controls__label {\n    padding: 8px 4px; }\n    .datepicker-controls__label button {\n      position: relative;\n      display: flex;\n      font-size: 15px;\n      font-weight: 500;\n      line-height: 15px;\n      padding: 0;\n      border: none;\n      outline: none; }\n      .datepicker-controls__label button:disabled, .datepicker-controls__label button[disabled] {\n        cursor: default;\n        color: rgba(0, 0, 0, 0.26); }\n  .datepicker-controls button.datepicker-controls__prev,\n  .datepicker-controls button.datepicker-controls__next {\n    position: relative;\n    flex: 0 0 40px;\n    height: 48px;\n    width: 48px;\n    padding: 0 8px 0 16px;\n    border: none;\n    outline: none;\n    background-color: transparent;\n    user-select: none;\n    cursor: pointer; }\n    @media only screen and (min-width: 768px) {\n      .datepicker-controls button.datepicker-controls__prev,\n      .datepicker-controls button.datepicker-controls__next {\n        height: 56px;\n        width: 56px; } }\n    .datepicker-controls button.datepicker-controls__prev:disabled, .datepicker-controls button.datepicker-controls__prev[disabled],\n    .datepicker-controls button.datepicker-controls__next:disabled,\n    .datepicker-controls button.datepicker-controls__next[disabled] {\n      cursor: default; }\n      .datepicker-controls button.datepicker-controls__prev:disabled svg, .datepicker-controls button.datepicker-controls__prev[disabled] svg,\n      .datepicker-controls button.datepicker-controls__next:disabled svg,\n      .datepicker-controls button.datepicker-controls__next[disabled] svg {\n        fill: rgba(0, 0, 0, 0.26); }\n  .datepicker-controls button.datepicker-controls__next {\n    padding: 0 16px 0 8px; }\n  .datepicker-controls svg {\n    width: 24px;\n    height: 24px;\n    fill: rgba(0, 0, 0, 0.87);\n    vertical-align: middle; }\n\n/*# sourceMappingURL=DatePickerControls.vue.map */",null]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$4 = "data-v-79905d6e";
    /* module identifier */
  ...
  __vue_render__$6._withStripped = true;
    ...
    const __vue_inject_styles__$6 = function (inject) {
      if (!inject) return
      inject("data-v-abc685c2_0", { source: "/*\n  Media Query mixin\n  @example scss\n\n  @include mq($from: mobile) {\n    color: red;\n  }\n  @include mq($to: tablet) {\n    color: blue;\n  }\n  @include mq(mobile, tablet) {\n    color: green;\n  }\n  @include mq($from: tablet, $and: '(orientation: landscape)') {\n    color: teal;\n  }\n*/\n.datepicker-preset[data-v-abc685c2] {\n  border: none;\n  margin: 0;\n  padding: 0;\n  width: auto;\n  overflow: visible;\n  background: transparent;\n  /* inherit font & color from ancestor */\n  color: inherit;\n  font: inherit;\n  /* Normalize `line-height`. Cannot be changed from `normal` in Firefox 4+. */\n  line-height: normal;\n  /* Corrects font smoothing for webkit */\n  -webkit-font-smoothing: inherit;\n  -moz-osx-font-smoothing: inherit;\n  /* Corrects inability to style clickable `input` types in iOS */\n  -webkit-appearance: none;\n}\n.datepicker-preset[data-v-abc685c2]:focus, .datepicker-preset[data-v-abc685c2]:active {\n    outline: 0;\n    box-shadow: 0;\n}\n.datepicker-preset[type=\"button\"][data-v-abc685c2], .datepicker-preset[type=\"reset\"][data-v-abc685c2], .datepicker-preset[type=\"submit\"][data-v-abc685c2], .datepicker-preset[role=\"button\"][data-v-abc685c2] {\n    cursor: pointer;\n}\n.datepicker-presets[data-v-abc685c2] {\n  position: relative;\n  display: flex;\n  padding: 16px 16px 8px;\n}\n.datepicker-presets__wrapper[data-v-abc685c2] {\n    position: relative;\n    display: grid;\n    grid-template-columns: repeat(3, 1fr);\n    grid-auto-rows: 32px;\n    width: 100%;\n}\n@media only screen and (min-width: 768px) {\n.datepicker-presets__wrapper[data-v-abc685c2] {\n        grid-auto-rows: 32px;\n}\n}\n.datepicker-preset[data-v-abc685c2] {\n  position: relative;\n  padding: 0 8px;\n  transition: opacity 450ms cubic-bezier(0.23, 1, 0.32, 1);\n  font-size: 14px;\n  line-height: 14px;\n  overflow: hidden;\n  border-color: #eef1f8;\n  border-style: solid;\n  border-width: 0;\n}\n.datepicker-preset[data-v-abc685c2]:nth-child(1) {\n    border-width: 1px;\n}\n.datepicker-preset[data-v-abc685c2]:nth-child(2), .datepicker-preset[data-v-abc685c2]:nth-child(3) {\n    border-width: 1px 1px 1px 0;\n}\n.datepicker-preset[data-v-abc685c2]:nth-child(4) {\n    border-width: 0 1px 1px 1px;\n}\n.datepicker-preset[data-v-abc685c2]:nth-child(5) {\n    border-width: 0 1px 1px 0;\n}\n.datepicker-preset__effect[data-v-abc685c2] {\n    position: absolute;\n    top: 0;\n    left: 0;\n    right: 0;\n    bottom: 0;\n    opacity: 0;\n    transition: opacity 450ms cubic-bezier(0.23, 1, 0.32, 1);\n    z-index: -1;\n}\n.datepicker-preset[data-v-abc685c2]:hover:not(.datepicker-preset--disabled) {\n    color: white;\n}\n.datepicker-preset:hover:not(.datepicker-preset--disabled) .datepicker-preset__effect[data-v-abc685c2] {\n      opacity: 1;\n}\n.datepicker-preset--selected[data-v-abc685c2] {\n    color: white;\n}\n.datepicker-preset--selected .datepicker-preset__effect[data-v-abc685c2] {\n      opacity: 1;\n}\n.datepicker-preset--disabled[data-v-abc685c2] {\n    color: rgba(93, 106, 137, 0.2);\n    cursor: not-allowed;\n    pointer-events: none;\n}\n\n/*# sourceMappingURL=DatePickerPresets.vue.map */", map: {"version":3,"sources":["DatePickerPresets.vue","/Users/stan/Web/Github/vue-datepicker/src/components/datepicker/DatePickerPresets.vue"],"names":[],"mappings":"AAAA;;;;;;;;;;;;;;;;CAgBC;AC4ED;EACA,YAAA;EACA,SAAA;EACA,UAAA;EACA,WAAA;ED1EE,iBAAiB;EC6EnB,uBAAA;EAEA,uCAAA;EACA,cAAA;EACA,aAAA;EAEA,4EAAA;EACA,mBAAA;EAEA,uCAAA;ED9EE,+BAA+B;ECgFjC,gCAAA;EAEA,+DAAA;EACA,wBAAA;AAAA;AAfA;IAmBA,UAAA;IACA,aAAA;AAAA;AApBA;IA2BA,eAAA;AAAA;AA7CA;EACA,kBAAA;EACA,aAAA;EACA,sBAAA;AAAA;AAEA;IACA,kBAAA;IACA,aAAA;IACA,qCAAA;IACA,oBAAA;IACA,WAAA;AAAA;ADxCI;ACmCJ;QAQA,oBAAA;AAAA;AAEA;AAGA;EACA,kBAAA;EAEA,cAAA;EACA,wDAAA;EACA,eAAA;EACA,iBAAA;EACA,gBAAA;EACA,qBAAA;EACA,mBAAA;EACA,eAAA;AAAA;AAVA;IAaA,iBAAA;AAAA;AAbA;IAiBA,2BAAA;AAAA;AAjBA;IAoBA,2BAAA;AAAA;AApBA;IAuBA,yBAAA;AAAA;AAGA;IACA,kBAAA;IACA,MAAA;IACA,OAAA;IACA,QAAA;IACA,SAAA;IACA,UAAA;IACA,wDAAA;IACA,WAAA;AAAA;AAlCA;IAsCA,YAAA;AAAA;AAtCA;MAyCA,UAAA;AAAA;AAIA;IACA,YAAA;AAAA;AADA;MAIA,UAAA;AAAA;AAZA;IAiBA,8BAAA;IACA,mBAAA;IACA,oBAAA;AAAA;;AD5DA,gDAAgD","file":"DatePickerPresets.vue","sourcesContent":["/*\n  Media Query mixin\n  @example scss\n\n  @include mq($from: mobile) {\n    color: red;\n  }\n  @include mq($to: tablet) {\n    color: blue;\n  }\n  @include mq(mobile, tablet) {\n    color: green;\n  }\n  @include mq($from: tablet, $and: '(orientation: landscape)') {\n    color: teal;\n  }\n*/\n.datepicker-preset {\n  border: none;\n  margin: 0;\n  padding: 0;\n  width: auto;\n  overflow: visible;\n  background: transparent;\n  /* inherit font & color from ancestor */\n  color: inherit;\n  font: inherit;\n  /* Normalize `line-height`. Cannot be changed from `normal` in Firefox 4+. */\n  line-height: normal;\n  /* Corrects font smoothing for webkit */\n  -webkit-font-smoothing: inherit;\n  -moz-osx-font-smoothing: inherit;\n  /* Corrects inability to style clickable `input` types in iOS */\n  -webkit-appearance: none; }\n  .datepicker-preset:focus, .datepicker-preset:active {\n    outline: 0;\n    box-shadow: 0; }\n  .datepicker-preset[type=\"button\"], .datepicker-preset[type=\"reset\"], .datepicker-preset[type=\"submit\"], .datepicker-preset[role=\"button\"] {\n    cursor: pointer; }\n\n.datepicker-presets {\n  position: relative;\n  display: flex;\n  padding: 16px 16px 8px; }\n  .datepicker-presets__wrapper {\n    position: relative;\n    display: grid;\n    grid-template-columns: repeat(3, 1fr);\n    grid-auto-rows: 32px;\n    width: 100%; }\n    @media only screen and (min-width: 768px) {\n      .datepicker-presets__wrapper {\n        grid-auto-rows: 32px; } }\n\n.datepicker-preset {\n  position: relative;\n  padding: 0 8px;\n  transition: opacity 450ms cubic-bezier(0.23, 1, 0.32, 1);\n  font-size: 14px;\n  line-height: 14px;\n  overflow: hidden;\n  border-color: #eef1f8;\n  border-style: solid;\n  border-width: 0; }\n  .datepicker-preset:nth-child(1) {\n    border-width: 1px; }\n  .datepicker-preset:nth-child(2), .datepicker-preset:nth-child(3) {\n    border-width: 1px 1px 1px 0; }\n  .datepicker-preset:nth-child(4) {\n    border-width: 0 1px 1px 1px; }\n  .datepicker-preset:nth-child(5) {\n    border-width: 0 1px 1px 0; }\n  .datepicker-preset__effect {\n    position: absolute;\n    top: 0;\n    left: 0;\n    right: 0;\n    bottom: 0;\n    opacity: 0;\n    transition: opacity 450ms cubic-bezier(0.23, 1, 0.32, 1);\n    z-index: -1; }\n  .datepicker-preset:hover:not(.datepicker-preset--disabled) {\n    color: white; }\n    .datepicker-preset:hover:not(.datepicker-preset--disabled) .datepicker-preset__effect {\n      opacity: 1; }\n  .datepicker-preset--selected {\n    color: white; }\n    .datepicker-preset--selected .datepicker-preset__effect {\n      opacity: 1; }\n  .datepicker-preset--disabled {\n    color: rgba(93, 106, 137, 0.2);\n    cursor: not-allowed;\n    pointer-events: none; }\n\n/*# sourceMappingURL=DatePickerPresets.vue.map */",null]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$6 = "data-v-abc685c2";
    /* module identifier */
  ...
  __vue_render__$7._withStripped = true;
    ...
    const __vue_inject_styles__$7 = function (inject) {
      if (!inject) return
      inject("data-v-7044a3bd_0", { source: "/*\n  Media Query mixin\n  @example scss\n\n  @include mq($from: mobile) {\n    color: red;\n  }\n  @include mq($to: tablet) {\n    color: blue;\n  }\n  @include mq(mobile, tablet) {\n    color: green;\n  }\n  @include mq($from: tablet, $and: '(orientation: landscape)') {\n    color: teal;\n  }\n*/\n.datepicker-validate__button[data-v-7044a3bd] {\n  border: none;\n  margin: 0;\n  padding: 0;\n  width: auto;\n  overflow: visible;\n  background: transparent;\n  /* inherit font & color from ancestor */\n  color: inherit;\n  font: inherit;\n  /* Normalize `line-height`. Cannot be changed from `normal` in Firefox 4+. */\n  line-height: normal;\n  /* Corrects font smoothing for webkit */\n  -webkit-font-smoothing: inherit;\n  -moz-osx-font-smoothing: inherit;\n  /* Corrects inability to style clickable `input` types in iOS */\n  -webkit-appearance: none;\n}\n.datepicker-validate__button[data-v-7044a3bd]:focus, .datepicker-validate__button[data-v-7044a3bd]:active {\n    outline: 0;\n    box-shadow: 0;\n}\n.datepicker-validate__button[type=\"button\"][data-v-7044a3bd], .datepicker-validate__button[type=\"reset\"][data-v-7044a3bd], .datepicker-validate__button[type=\"submit\"][data-v-7044a3bd], .datepicker-validate__button[role=\"button\"][data-v-7044a3bd] {\n    cursor: pointer;\n}\n.datepicker-validate[data-v-7044a3bd] {\n  position: relative;\n  display: flex;\n  align-items: center;\n  justify-content: flex-end;\n  padding: 0 16px 8px 16px;\n}\n.datepicker-validate__button[data-v-7044a3bd] {\n    position: relative;\n    display: inline-flex;\n    flex: 0 0 auto;\n    align-items: center;\n    justify-content: center;\n    height: 36px;\n    min-width: 88px;\n    font-size: 14px;\n    font-weight: 500;\n    border-radius: 4px;\n    margin: 6px 8px;\n    outline: 0;\n    text-transform: uppercase;\n    text-decoration: none;\n    overflow: hidden;\n}\n.datepicker-validate__button:hover .datepicker-validate__effect[data-v-7044a3bd] {\n      opacity: .1;\n}\n.datepicker-validate__effect[data-v-7044a3bd] {\n    position: absolute;\n    top: 0;\n    left: 0;\n    right: 0;\n    bottom: 0;\n    opacity: 0;\n    transition: opacity 450ms cubic-bezier(0.23, 1, 0.32, 1);\n    z-index: -1;\n}\n\n/*# sourceMappingURL=DatePickerValidate.vue.map */", map: {"version":3,"sources":["DatePickerValidate.vue","/Users/stan/Web/Github/vue-datepicker/src/components/datepicker/DatePickerValidate.vue"],"names":[],"mappings":"AAAA;;;;;;;;;;;;;;;;CAgBC;ACqCD;EDnCE,YAAY;EACZ,SAAS;EACT,UAAU;EACV,WAAW;EACX,iBAAiB;EACjB,uBAAuB;EACvB,uCAAuC;EACvC,cAAc;EACd,aAAa;EACb,4EAA4E;EAC5E,mBAAmB;EACnB,uCAAuC;EACvC,+BAA+B;EAC/B,gCAAgC;EAChC,+DAA+D;EAC/D,wBAAwB;AAAE;ACoB5B;IDlBI,UAAU;IACV,aAAa;AAAE;ACiBnB;IDfI,eAAe;AAAE;ACQrB;EACA,kBAAA;EACA,aAAA;EACA,mBAAA;EACA,yBAAA;EACA,wBAAA;AAAA;AAEA;IAEA,kBAAA;IACA,oBAAA;IACA,cAAA;IACA,mBAAA;IACA,uBAAA;IACA,YAAA;IACA,eAAA;IACA,eAAA;IACA,gBAAA;IACA,kBAhBA;IAiBA,eAAA;IACA,UAAA;IACA,yBAAA;IACA,qBAAA;IACA,gBAAA;AAAA;AAhBA;MAoBA,WAAA;AAAA;AAKA;IACA,kBAAA;IACA,MAAA;IACA,OAAA;IACA,QAAA;IACA,SAAA;IACA,UAAA;IACA,wDAAA;IACA,WAAA;AAAA;;ADZA,iDAAiD","file":"DatePickerValidate.vue","sourcesContent":["/*\n  Media Query mixin\n  @example scss\n\n  @include mq($from: mobile) {\n    color: red;\n  }\n  @include mq($to: tablet) {\n    color: blue;\n  }\n  @include mq(mobile, tablet) {\n    color: green;\n  }\n  @include mq($from: tablet, $and: '(orientation: landscape)') {\n    color: teal;\n  }\n*/\n.datepicker-validate__button {\n  border: none;\n  margin: 0;\n  padding: 0;\n  width: auto;\n  overflow: visible;\n  background: transparent;\n  /* inherit font & color from ancestor */\n  color: inherit;\n  font: inherit;\n  /* Normalize `line-height`. Cannot be changed from `normal` in Firefox 4+. */\n  line-height: normal;\n  /* Corrects font smoothing for webkit */\n  -webkit-font-smoothing: inherit;\n  -moz-osx-font-smoothing: inherit;\n  /* Corrects inability to style clickable `input` types in iOS */\n  -webkit-appearance: none; }\n  .datepicker-validate__button:focus, .datepicker-validate__button:active {\n    outline: 0;\n    box-shadow: 0; }\n  .datepicker-validate__button[type=\"button\"], .datepicker-validate__button[type=\"reset\"], .datepicker-validate__button[type=\"submit\"], .datepicker-validate__button[role=\"button\"] {\n    cursor: pointer; }\n\n.datepicker-validate {\n  position: relative;\n  display: flex;\n  align-items: center;\n  justify-content: flex-end;\n  padding: 0 16px 8px 16px; }\n  .datepicker-validate__button {\n    position: relative;\n    display: inline-flex;\n    flex: 0 0 auto;\n    align-items: center;\n    justify-content: center;\n    height: 36px;\n    min-width: 88px;\n    font-size: 14px;\n    font-weight: 500;\n    border-radius: 4px;\n    margin: 6px 8px;\n    outline: 0;\n    text-transform: uppercase;\n    text-decoration: none;\n    overflow: hidden; }\n    .datepicker-validate__button:hover .datepicker-validate__effect {\n      opacity: .1; }\n  .datepicker-validate__effect {\n    position: absolute;\n    top: 0;\n    left: 0;\n    right: 0;\n    bottom: 0;\n    opacity: 0;\n    transition: opacity 450ms cubic-bezier(0.23, 1, 0.32, 1);\n    z-index: -1; }\n\n/*# sourceMappingURL=DatePickerValidate.vue.map */",null]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$7 = "data-v-7044a3bd";
    /* module identifier */
  ...
  __vue_render__$8._withStripped = true;
    ...
    const __vue_inject_styles__$8 = function (inject) {
      if (!inject) return
      inject("data-v-ee5455a2_0", { source: "/*\n  Media Query mixin\n  @example scss\n\n  @include mq($from: mobile) {\n    color: red;\n  }\n  @include mq($to: tablet) {\n    color: blue;\n  }\n  @include mq(mobile, tablet) {\n    color: green;\n  }\n  @include mq($from: tablet, $and: '(orientation: landscape)') {\n    color: teal;\n  }\n*/\n.datepicker-days .datepicker-day[data-v-ee5455a2] {\n  border: none;\n  margin: 0;\n  padding: 0;\n  width: auto;\n  overflow: visible;\n  background: transparent;\n  /* inherit font & color from ancestor */\n  color: inherit;\n  font: inherit;\n  /* Normalize `line-height`. Cannot be changed from `normal` in Firefox 4+. */\n  line-height: normal;\n  /* Corrects font smoothing for webkit */\n  -webkit-font-smoothing: inherit;\n  -moz-osx-font-smoothing: inherit;\n  /* Corrects inability to style clickable `input` types in iOS */\n  -webkit-appearance: none;\n}\n.datepicker-days .datepicker-day[data-v-ee5455a2]:focus, .datepicker-days .datepicker-day[data-v-ee5455a2]:active {\n    outline: 0;\n    box-shadow: 0;\n}\n.datepicker-days .datepicker-day[type=\"button\"][data-v-ee5455a2], .datepicker-days .datepicker-day[type=\"reset\"][data-v-ee5455a2], .datepicker-days .datepicker-day[type=\"submit\"][data-v-ee5455a2], .datepicker-days .datepicker-day[role=\"button\"][data-v-ee5455a2] {\n    cursor: pointer;\n}\n.slide-h-next-leave-active[data-v-ee5455a2],\n.slide-h-next-enter-active[data-v-ee5455a2],\n.slide-h-prev-leave-active[data-v-ee5455a2],\n.slide-h-prev-enter-active[data-v-ee5455a2] {\n  position: absolute;\n  transition: transform .3s, opacity .3s;\n}\n.slide-h-next-enter[data-v-ee5455a2], .slide-h-prev-leave-to[data-v-ee5455a2] {\n  transform: translateX(100%);\n  opacity: 0;\n}\n.slide-h-next-leave-to[data-v-ee5455a2], .slide-h-prev-enter[data-v-ee5455a2] {\n  transform: translateX(-100%);\n  opacity: 0;\n}\n.slide-v-next-leave-active[data-v-ee5455a2],\n.slide-v-next-enter-active[data-v-ee5455a2],\n.slide-v-prev-leave-active[data-v-ee5455a2],\n.slide-v-prev-enter-active[data-v-ee5455a2] {\n  position: absolute;\n  transition: transform .3s, opacity .3s;\n}\n.slide-v-next-enter[data-v-ee5455a2], .slide-v-prev-leave-to[data-v-ee5455a2] {\n  transform: translateY(100%);\n  opacity: 0;\n}\n.slide-v-next-leave-to[data-v-ee5455a2], .slide-v-prev-enter[data-v-ee5455a2] {\n  transform: translateY(-100%);\n  opacity: 0;\n}\n.yearMonth-leave-active[data-v-ee5455a2], .yearMonth-enter-active[data-v-ee5455a2] {\n  position: absolute;\n  transition: opacity .3s;\n}\n.yearMonth-enter[data-v-ee5455a2], .yearMonth-leave-to[data-v-ee5455a2] {\n  opacity: 0;\n}\n.datepicker[data-v-ee5455a2] {\n  position: absolute;\n  display: flex;\n  flex-direction: column;\n  width: 290px;\n  left: 0;\n  top: 100%;\n  will-change: transform;\n  background-color: white;\n  border-radius: 6px;\n  box-shadow: 0 2px 8px rgba(50, 50, 93, 0.2);\n  /* Title\n  ---------------------- */\n  /* Contsnt\n  ---------------------- */\n  /* Week\n  ---------------------- */\n  /* Days\n  ---------------------- */\n}\n.datepicker[data-v-ee5455a2]:focus, .datepicker[data-v-ee5455a2]:active {\n    outline: 0;\n}\n@media only screen and (min-width: 768px) {\n.datepicker[data-v-ee5455a2] {\n      width: 315px;\n}\n}\n.datepicker--inline[data-v-ee5455a2] {\n    position: relative;\n    box-shadow: 0px 3px 1px -2px rgba(0, 0, 0, 0.2), 0px 2px 2px 0px rgba(0, 0, 0, 0.14), 0px 1px 5px 0px rgba(0, 0, 0, 0.12);\n}\n@media only screen and (max-width: 479px) {\n.datepicker--fullscreen-mobile[data-v-ee5455a2] {\n      position: fixed;\n      top: auto !important;\n      bottom: 0 !important;\n      left: 0 !important;\n      right: 0 !important;\n      width: 100%;\n      border-radius: 12px 12px 0 0;\n}\n@supports (padding-bottom: constant(safe-area-inset-bottom)) {\n.datepicker--fullscreen-mobile[data-v-ee5455a2] {\n          --safe-area-inset-bottom: constant(safe-area-inset-bottom);\n          padding-bottom: var(--safe-area-inset-bottom);\n}\n}\n@supports (padding-bottom: env(safe-area-inset-bottom)) {\n.datepicker--fullscreen-mobile[data-v-ee5455a2] {\n          --safe-area-inset-bottom: env(safe-area-inset-bottom);\n          padding-bottom: var(--safe-area-inset-bottom);\n}\n}\n.datepicker--fullscreen-mobile .datepicker-header[data-v-ee5455a2] {\n        border-radius: 0;\n}\n}\n.datepicker-title[data-v-ee5455a2] {\n    position: relative;\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    min-height: 48px;\n    padding: 0 0 0 16px;\n    border-radius: 12px 12px 0 0;\n}\n@media only screen and (min-width: 480px) {\n.datepicker-title[data-v-ee5455a2] {\n        display: none;\n}\n}\n.datepicker-title p[data-v-ee5455a2] {\n      margin: 0;\n}\n.datepicker-title button[data-v-ee5455a2] {\n      position: relative;\n      flex: 0 0 40px;\n      height: 48px;\n      width: 48px;\n      padding: 0 16px 0 8px;\n      border: none;\n      outline: none;\n      background-color: transparent;\n      user-select: none;\n}\n@media only screen and (min-width: 768px) {\n.datepicker-title button[data-v-ee5455a2] {\n          height: 56px;\n          width: 56px;\n}\n}\n.datepicker-title button svg[data-v-ee5455a2] {\n        width: 24px;\n        height: 24px;\n}\n.datepicker-content[data-v-ee5455a2] {\n    position: relative;\n    display: flex;\n    flex-direction: column;\n    flex: 1 1 auto;\n}\n.datepicker-week[data-v-ee5455a2] {\n    font-size: 12px;\n    line-height: 12px;\n    font-weight: 500;\n    padding: 8px 12px;\n    color: rgba(0, 0, 0, 0.38);\n}\n@media only screen and (min-width: 768px) {\n.datepicker-week[data-v-ee5455a2] {\n        padding: 8px 14px;\n}\n}\n.datepicker-week .datepicker-weekday[data-v-ee5455a2] {\n      float: left;\n      width: calc(100% / 7);\n      text-align: center;\n}\n@media only screen and (min-width: 768px) {\n.datepicker-week .datepicker-weekday[data-v-ee5455a2] {\n          width: 40px;\n}\n}\n.datepicker-days__wrapper[data-v-ee5455a2] {\n    position: relative;\n    height: 180px;\n    margin: 0 12px 12px;\n    overflow: hidden;\n    transition: height 0.3s cubic-bezier(0.23, 1, 0.32, 1);\n}\n@media only screen and (min-width: 768px) {\n.datepicker-days__wrapper[data-v-ee5455a2] {\n        margin: 0 14px 14px;\n        height: 200px;\n}\n}\n.datepicker-days__wrapper.has-6-weeks[data-v-ee5455a2] {\n      height: 216px;\n}\n@media only screen and (min-width: 768px) {\n.datepicker-days__wrapper.has-6-weeks[data-v-ee5455a2] {\n          height: 240px;\n}\n}\n.datepicker-days[data-v-ee5455a2] {\n    display: flex;\n    flex-wrap: wrap;\n    overflow: hidden;\n    width: 100%;\n}\n.datepicker-days .datepicker-day[data-v-ee5455a2] {\n      position: relative;\n      width: calc(100% / 7);\n      height: 36px;\n      line-height: 1;\n      font-size: 12px;\n      float: left;\n      text-align: center;\n      color: rgba(0, 0, 0, 0.87);\n      font-weight: 500;\n      transition: color 450ms cubic-bezier(0.23, 1, 0.32, 1);\n      overflow: hidden;\n}\n@media only screen and (min-width: 768px) {\n.datepicker-days .datepicker-day[data-v-ee5455a2] {\n          width: calc(100% / 7);\n          height: 40px;\n}\n}\n.datepicker-days .datepicker-day[data-v-ee5455a2]:hover:not(.disabled) {\n        color: white;\n}\n.datepicker-days .datepicker-day:hover:not(.disabled) .datepicker-day__effect[data-v-ee5455a2] {\n          transform: translateX(-50%) scale(1);\n          opacity: .5;\n}\n.datepicker-days .datepicker-day.in-range[data-v-ee5455a2]:not(.disabled), .datepicker-days .datepicker-day.between[data-v-ee5455a2]:not(.disabled) {\n        color: white;\n}\n.datepicker-days .datepicker-day.in-range:not(.disabled) .datepicker-day__effect[data-v-ee5455a2], .datepicker-days .datepicker-day.between:not(.disabled) .datepicker-day__effect[data-v-ee5455a2] {\n          transform: translateX(-50%);\n          opacity: 1;\n          left: 0;\n          width: calc(100% + 1px);\n          border-radius: 0;\n          opacity: .5;\n}\n.datepicker-days .datepicker-day.in-range:not(.disabled) .datepicker-day__effect[data-v-ee5455a2]:before, .datepicker-days .datepicker-day.between:not(.disabled) .datepicker-day__effect[data-v-ee5455a2]:before {\n            opacity: 1;\n            left: 50%;\n}\n.datepicker-days .datepicker-day.selected[data-v-ee5455a2] {\n        color: white;\n}\n.datepicker-days .datepicker-day.selected:hover:not(.disabled) .datepicker-day__effect[data-v-ee5455a2] {\n          opacity: 1;\n}\n.datepicker-days .datepicker-day.selected .datepicker-day__effect[data-v-ee5455a2] {\n          transform: translateX(-50%);\n          opacity: 1;\n}\n.datepicker-days .datepicker-day.first .datepicker-day__effect[data-v-ee5455a2], .datepicker-days .datepicker-day.select-start:hover:not(.selected) .datepicker-day__effect[data-v-ee5455a2] {\n        opacity: 1;\n}\n.datepicker-days .datepicker-day.first .datepicker-day__effect[data-v-ee5455a2]:before, .datepicker-days .datepicker-day.select-start:hover:not(.selected) .datepicker-day__effect[data-v-ee5455a2]:before {\n          opacity: .5;\n          left: 50%;\n}\n.datepicker-days .datepicker-day.last .datepicker-day__effect[data-v-ee5455a2], .datepicker-days .datepicker-day.select-end:hover:not(.selected) .datepicker-day__effect[data-v-ee5455a2] {\n        opacity: 1;\n}\n.datepicker-days .datepicker-day.last .datepicker-day__effect[data-v-ee5455a2]:before, .datepicker-days .datepicker-day.select-end:hover:not(.selected) .datepicker-day__effect[data-v-ee5455a2]:before {\n          opacity: .5;\n          left: -50%;\n}\n.datepicker-days .datepicker-day.first.last .datepicker-day__effect[data-v-ee5455a2]:before {\n        opacity: 0;\n}\n.datepicker-days .datepicker-day.disabled[data-v-ee5455a2] {\n        cursor: default;\n        color: rgba(0, 0, 0, 0.26);\n}\n.datepicker-days .datepicker-day.disabled:hover .datepicker-day__effect[data-v-ee5455a2],\n        .datepicker-days .datepicker-day.disabled:hover .datepicker-day__effect[data-v-ee5455a2]:before {\n          opacity: 0 !important;\n}\n.datepicker-days .datepicker-day--current[data-v-ee5455a2] {\n      position: absolute;\n      top: 1px;\n      left: 50%;\n      transform: translateX(-50%);\n      width: 34px;\n      height: 34px;\n      border-radius: 50%;\n      border: 1px solid currentColor;\n}\n@media only screen and (min-width: 768px) {\n.datepicker-days .datepicker-day--current[data-v-ee5455a2] {\n          top: 4px;\n          width: 36px;\n          height: 36px;\n}\n}\n.datepicker-days .datepicker-day__effect[data-v-ee5455a2] {\n      position: absolute;\n      top: 1px;\n      left: 50%;\n      width: 34px;\n      height: 34px;\n      border-radius: 50%;\n      transition: all 450ms cubic-bezier(0.23, 1, 0.32, 1);\n      transition-property: transform, opacity;\n      transform: translateX(-50%) scale(0);\n}\n@media only screen and (min-width: 768px) {\n.datepicker-days .datepicker-day__effect[data-v-ee5455a2] {\n          top: 4px;\n          width: 36px;\n          height: 36px;\n}\n}\n.datepicker--range .datepicker-days .datepicker-day__effect[data-v-ee5455a2]:before {\n        content: \"\";\n        position: absolute;\n        top: 0;\n        left: 0;\n        width: 100%;\n        height: 100%;\n        background-color: inherit;\n        opacity: 0;\n}\n.datepicker--range-selecting .datepicker-days .datepicker-day__effect[data-v-ee5455a2] {\n        transform: translateX(-50%) scale(0);\n        opacity: 0;\n        transition: none;\n}\n.datepicker-days .datepicker-day__text[data-v-ee5455a2] {\n      position: relative;\n      vertical-align: sub;\n}\n.datepicker-transition-enter-active[data-v-ee5455a2], .datepicker-transition-leave-active[data-v-ee5455a2] {\n  opacity: 1;\n  transition: all 300ms;\n  transition-property: transform, opacity;\n  transform: scale(1);\n}\n@media only screen and (max-width: 479px) {\n.datepicker-transition-enter-active.datepicker--fullscreen-mobile[data-v-ee5455a2], .datepicker-transition-leave-active.datepicker--fullscreen-mobile[data-v-ee5455a2] {\n      transform: translateY(0);\n}\n}\n.datepicker-transition-leave-to[data-v-ee5455a2], .datepicker-transition-enter[data-v-ee5455a2] {\n  opacity: 0;\n  transform: scale(0);\n}\n@media only screen and (max-width: 479px) {\n.datepicker-transition-leave-to.datepicker--fullscreen-mobile[data-v-ee5455a2], .datepicker-transition-enter.datepicker--fullscreen-mobile[data-v-ee5455a2] {\n      transform: translateY(100%);\n}\n}\n\n/*# sourceMappingURL=DatePickerAgenda.vue.map */", map: {"version":3,"sources":["DatePickerAgenda.vue","/Users/stan/Web/Github/vue-datepicker/src/components/datepicker/DatePickerAgenda.vue"],"names":[],"mappings":"AAAA;;;;;;;;;;;;;;;;CAgBC;ACkpBD;EDhpBE,YAAY;EACZ,SAAS;EACT,UAAU;EACV,WAAW;EACX,iBAAiB;EACjB,uBAAuB;EACvB,uCAAuC;EACvC,cAAc;EACd,aAAa;EACb,4EAA4E;EAC5E,mBAAmB;EACnB,uCAAuC;EACvC,+BAA+B;EAC/B,gCAAgC;EAChC,+DAA+D;EAC/D,wBAAwB;AAAE;ACioB5B;ID/nBI,UAAU;IACV,aAAa;AAAE;AC8nBnB;ID5nBI,eAAe;AAAE;AAErB;;;;EAIE,kBAAkB;EAClB,sCAAsC;AAAE;AAE1C;EACE,2BAA2B;EAC3B,UAAU;AAAE;AAEd;EACE,4BAA4B;EAC5B,UAAU;AAAE;AAEd;;;;EAIE,kBAAkB;EAClB,sCAAsC;AAAE;AAE1C;EACE,2BAA2B;EAC3B,UAAU;AAAE;AAEd;EACE,4BAA4B;EAC5B,UAAU;AAAE;AAEd;EACE,kBAAkB;EAClB,uBAAuB;AAAE;AAE3B;EACE,UAAU;AAAE;AC6bd;EACA,kBAAA;EACA,aAAA;EACA,sBAAA;EACA,YAAA;EACA,OAAA;EACA,SAAA;EACA,sBAAA;EACA,uBAAA;EACA,kBAAA;EACA,2CAAA;EA8CA;0BDve0B;ECihB1B;0BD/gB0B;ECwhB1B;0BDthB0B;EC8iB1B;0BD5iB0B;AC6iB1B;AApIA;IAcA,UAAA;AAAA;ADpbE;ACsaF;MAkBA,YAAA;AAAA;AA+SA;AA5SA;IACA,kBAAA;IACA,yHAEA;AAAA;ADzbE;AC4bF;MAEA,eAAA;MACA,oBAAA;MACA,oBAAA;MACA,kBAAA;MACA,mBAAA;MACA,WAAA;MACA,4BAAA;AAAA;AAGA;AAXA;UAYA,0DAAA;UACA,6CAAA;AAAA;AAaA;AATA;AAjBA;UAkBA,qDAAA;UACA,6CAAA;AAAA;AAOA;AA1BA;QAuBA,gBAAA;AAAA;AACA;AAMA;IACA,kBAAA;IACA,aAAA;IACA,8BAAA;IACA,mBAAA;IACA,gBAAA;IACA,mBAAA;IACA,4BAAA;AAAA;ADtcI;AC+bJ;QAUA,aAAA;AAAA;AA4BA;AAtCA;MAcA,SAAA;AAAA;AAdA;MAkBA,kBAAA;MACA,cAAA;MACA,YAAA;MACA,WAAA;MACA,qBAAA;MACA,YAAA;MACA,aAAA;MACA,6BAAA;MACA,iBAAA;AAAA;AD1cM;ACgbN;UA6BA,YAAA;UACA,WAAA;AAAA;AAOA;AArCA;QAkCA,WAAA;QACA,YAAA;AAAA;AAOA;IACA,kBAAA;IACA,aAAA;IACA,sBAAA;IACA,cAAA;AAAA;AAKA;IACA,eAAA;IACA,iBAAA;IACA,gBAAA;IACA,iBAAA;IACA,0BAAA;AAAA;ADtdI;ACidJ;QAQA,iBAAA;AAAA;AAYA;AApBA;MAYA,WAAA;MACA,qBAAA;MACA,kBAAA;AAAA;ADxdM;AC0cN;UAiBA,WAAA;AAAA;AAEA;AAKA;IACA,kBAAA;IACA,aAAA;IACA,mBAAA;IACA,gBAAA;IACA,sDAAA;AAAA;AD9dI;ACydJ;QAQA,mBAAA;QACA,aAAA;AAAA;AAUA;AAnBA;MAaA,aAAA;AAAA;ADheM;ACmdN;UAgBA,aAAA;AAAA;AAEA;AAGA;IACA,aAAA;IACA,eAAA;IACA,gBAAA;IACA,WAAA;AAAA;AAJA;MAQA,kBAAA;MACA,qBAAA;MACA,YAAA;MACA,cAAA;MACA,eAAA;MACA,WAAA;MACA,kBAAA;MACA,0BAAA;MACA,gBAAA;MACA,sDAAA;MACA,gBAAA;AAAA;ADteM;ACodN;UAqBA,qBAAA;UACA,YAAA;AAAA;AAmFA;AAzGA;QA0BA,YAAA;AAAA;AA1BA;UA6BA,oCAAA;UACA,WAAA;AAAA;AA9BA;QAmCA,YAAA;AAAA;AAnCA;UAsCA,2BAAA;UACA,UAAA;UACA,OAAA;UACA,uBAAA;UACA,gBAAA;UACA,WAAA;AAAA;AA3CA;YA8CA,UAAA;YACA,SAAA;AAAA;AA/CA;QAoDA,YAAA;AAAA;AApDA;UAwDA,UAAA;AAAA;AAxDA;UA6DA,2BAAA;UACA,UAAA;AAAA;AA9DA;QAoEA,UAAA;AAAA;AApEA;UAuEA,WAAA;UACA,SAAA;AAAA;AAxEA;QA+EA,UAAA;AAAA;AA/EA;UAkFA,WAAA;UACA,UAAA;AAAA;AAnFA;QA0FA,UAAA;AAAA;AA1FA;QA+FA,eAAA;QACA,0BAAA;AAAA;AAhGA;;UAqGA,qBAAA;AAAA;AArGA;MA4GA,kBAAA;MACA,QAAA;MACA,SAAA;MACA,2BAAA;MACA,WAAA;MACA,YAAA;MACA,kBAAA;MACA,8BAAA;AAAA;ADhhBM;AC6ZN;UAsHA,QAAA;UACA,WAAA;UACA,YAAA;AAAA;AAEA;AA1HA;MA6HA,kBAAA;MACA,QAAA;MACA,SAAA;MACA,WAAA;MACA,YAAA;MACA,kBAAA;MACA,oDAAA;MACA,uCAAA;MACA,oCAAA;AAAA;ADnhBM;AC8YN;UAwIA,QAAA;UACA,WAAA;UACA,YAAA;AAAA;AAqBA;AAlBA;QAEA,WAAA;QACA,kBAAA;QACA,MAAA;QACA,OAAA;QACA,WAAA;QACA,YAAA;QACA,yBAAA;QACA,UAAA;AAAA;AAIA;QACA,oCAAA;QACA,UAAA;QACA,gBAAA;AAAA;AA7JA;MAkKA,kBAAA;MACA,mBAAA;AAAA;AASA;EAEA,UAAA;EACA,qBAAA;EACA,uCAAA;EACA,mBAAA;AAAA;ADpiBE;AC+hBF;MASA,wBAAA;AAAA;AACA;AAIA;EAEA,UAAA;EACA,mBAAA;AAAA;ADziBE;ACsiBF;MAOA,2BAAA;AAAA;AACA;;AD1iBA,+CAA+C","file":"DatePickerAgenda.vue","sourcesContent":["/*\n  Media Query mixin\n  @example scss\n\n  @include mq($from: mobile) {\n    color: red;\n  }\n  @include mq($to: tablet) {\n    color: blue;\n  }\n  @include mq(mobile, tablet) {\n    color: green;\n  }\n  @include mq($from: tablet, $and: '(orientation: landscape)') {\n    color: teal;\n  }\n*/\n.datepicker-days .datepicker-day {\n  border: none;\n  margin: 0;\n  padding: 0;\n  width: auto;\n  overflow: visible;\n  background: transparent;\n  /* inherit font & color from ancestor */\n  color: inherit;\n  font: inherit;\n  /* Normalize `line-height`. Cannot be changed from `normal` in Firefox 4+. */\n  line-height: normal;\n  /* Corrects font smoothing for webkit */\n  -webkit-font-smoothing: inherit;\n  -moz-osx-font-smoothing: inherit;\n  /* Corrects inability to style clickable `input` types in iOS */\n  -webkit-appearance: none; }\n  .datepicker-days .datepicker-day:focus, .datepicker-days .datepicker-day:active {\n    outline: 0;\n    box-shadow: 0; }\n  .datepicker-days .datepicker-day[type=\"button\"], .datepicker-days .datepicker-day[type=\"reset\"], .datepicker-days .datepicker-day[type=\"submit\"], .datepicker-days .datepicker-day[role=\"button\"] {\n    cursor: pointer; }\n\n.slide-h-next-leave-active,\n.slide-h-next-enter-active,\n.slide-h-prev-leave-active,\n.slide-h-prev-enter-active {\n  position: absolute;\n  transition: transform .3s, opacity .3s; }\n\n.slide-h-next-enter, .slide-h-prev-leave-to {\n  transform: translateX(100%);\n  opacity: 0; }\n\n.slide-h-next-leave-to, .slide-h-prev-enter {\n  transform: translateX(-100%);\n  opacity: 0; }\n\n.slide-v-next-leave-active,\n.slide-v-next-enter-active,\n.slide-v-prev-leave-active,\n.slide-v-prev-enter-active {\n  position: absolute;\n  transition: transform .3s, opacity .3s; }\n\n.slide-v-next-enter, .slide-v-prev-leave-to {\n  transform: translateY(100%);\n  opacity: 0; }\n\n.slide-v-next-leave-to, .slide-v-prev-enter {\n  transform: translateY(-100%);\n  opacity: 0; }\n\n.yearMonth-leave-active, .yearMonth-enter-active {\n  position: absolute;\n  transition: opacity .3s; }\n\n.yearMonth-enter, .yearMonth-leave-to {\n  opacity: 0; }\n\n.datepicker {\n  position: absolute;\n  display: flex;\n  flex-direction: column;\n  width: 290px;\n  left: 0;\n  top: 100%;\n  will-change: transform;\n  background-color: white;\n  border-radius: 6px;\n  box-shadow: 0 2px 8px rgba(50, 50, 93, 0.2);\n  /* Title\n  ---------------------- */\n  /* Contsnt\n  ---------------------- */\n  /* Week\n  ---------------------- */\n  /* Days\n  ---------------------- */ }\n  .datepicker:focus, .datepicker:active {\n    outline: 0; }\n  @media only screen and (min-width: 768px) {\n    .datepicker {\n      width: 315px; } }\n  .datepicker--inline {\n    position: relative;\n    box-shadow: 0px 3px 1px -2px rgba(0, 0, 0, 0.2), 0px 2px 2px 0px rgba(0, 0, 0, 0.14), 0px 1px 5px 0px rgba(0, 0, 0, 0.12); }\n  @media only screen and (max-width: 479px) {\n    .datepicker--fullscreen-mobile {\n      position: fixed;\n      top: auto !important;\n      bottom: 0 !important;\n      left: 0 !important;\n      right: 0 !important;\n      width: 100%;\n      border-radius: 12px 12px 0 0; }\n      @supports (padding-bottom: constant(safe-area-inset-bottom)) {\n        .datepicker--fullscreen-mobile {\n          --safe-area-inset-bottom: constant(safe-area-inset-bottom);\n          padding-bottom: var(--safe-area-inset-bottom); } }\n      @supports (padding-bottom: env(safe-area-inset-bottom)) {\n        .datepicker--fullscreen-mobile {\n          --safe-area-inset-bottom: env(safe-area-inset-bottom);\n          padding-bottom: var(--safe-area-inset-bottom); } }\n      .datepicker--fullscreen-mobile .datepicker-header {\n        border-radius: 0; } }\n  .datepicker-title {\n    position: relative;\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    min-height: 48px;\n    padding: 0 0 0 16px;\n    border-radius: 12px 12px 0 0; }\n    @media only screen and (min-width: 480px) {\n      .datepicker-title {\n        display: none; } }\n    .datepicker-title p {\n      margin: 0; }\n    .datepicker-title button {\n      position: relative;\n      flex: 0 0 40px;\n      height: 48px;\n      width: 48px;\n      padding: 0 16px 0 8px;\n      border: none;\n      outline: none;\n      background-color: transparent;\n      user-select: none; }\n      @media only screen and (min-width: 768px) {\n        .datepicker-title button {\n          height: 56px;\n          width: 56px; } }\n      .datepicker-title button svg {\n        width: 24px;\n        height: 24px; }\n  .datepicker-content {\n    position: relative;\n    display: flex;\n    flex-direction: column;\n    flex: 1 1 auto; }\n  .datepicker-week {\n    font-size: 12px;\n    line-height: 12px;\n    font-weight: 500;\n    padding: 8px 12px;\n    color: rgba(0, 0, 0, 0.38); }\n    @media only screen and (min-width: 768px) {\n      .datepicker-week {\n        padding: 8px 14px; } }\n    .datepicker-week .datepicker-weekday {\n      float: left;\n      width: calc(100% / 7);\n      text-align: center; }\n      @media only screen and (min-width: 768px) {\n        .datepicker-week .datepicker-weekday {\n          width: 40px; } }\n  .datepicker-days__wrapper {\n    position: relative;\n    height: 180px;\n    margin: 0 12px 12px;\n    overflow: hidden;\n    transition: height 0.3s cubic-bezier(0.23, 1, 0.32, 1); }\n    @media only screen and (min-width: 768px) {\n      .datepicker-days__wrapper {\n        margin: 0 14px 14px;\n        height: 200px; } }\n    .datepicker-days__wrapper.has-6-weeks {\n      height: 216px; }\n      @media only screen and (min-width: 768px) {\n        .datepicker-days__wrapper.has-6-weeks {\n          height: 240px; } }\n  .datepicker-days {\n    display: flex;\n    flex-wrap: wrap;\n    overflow: hidden;\n    width: 100%; }\n    .datepicker-days .datepicker-day {\n      position: relative;\n      width: calc(100% / 7);\n      height: 36px;\n      line-height: 1;\n      font-size: 12px;\n      float: left;\n      text-align: center;\n      color: rgba(0, 0, 0, 0.87);\n      font-weight: 500;\n      transition: color 450ms cubic-bezier(0.23, 1, 0.32, 1);\n      overflow: hidden; }\n      @media only screen and (min-width: 768px) {\n        .datepicker-days .datepicker-day {\n          width: calc(100% / 7);\n          height: 40px; } }\n      .datepicker-days .datepicker-day:hover:not(.disabled) {\n        color: white; }\n        .datepicker-days .datepicker-day:hover:not(.disabled) .datepicker-day__effect {\n          transform: translateX(-50%) scale(1);\n          opacity: .5; }\n      .datepicker-days .datepicker-day.in-range:not(.disabled), .datepicker-days .datepicker-day.between:not(.disabled) {\n        color: white; }\n        .datepicker-days .datepicker-day.in-range:not(.disabled) .datepicker-day__effect, .datepicker-days .datepicker-day.between:not(.disabled) .datepicker-day__effect {\n          transform: translateX(-50%);\n          opacity: 1;\n          left: 0;\n          width: calc(100% + 1px);\n          border-radius: 0;\n          opacity: .5; }\n          .datepicker-days .datepicker-day.in-range:not(.disabled) .datepicker-day__effect:before, .datepicker-days .datepicker-day.between:not(.disabled) .datepicker-day__effect:before {\n            opacity: 1;\n            left: 50%; }\n      .datepicker-days .datepicker-day.selected {\n        color: white; }\n        .datepicker-days .datepicker-day.selected:hover:not(.disabled) .datepicker-day__effect {\n          opacity: 1; }\n        .datepicker-days .datepicker-day.selected .datepicker-day__effect {\n          transform: translateX(-50%);\n          opacity: 1; }\n      .datepicker-days .datepicker-day.first .datepicker-day__effect, .datepicker-days .datepicker-day.select-start:hover:not(.selected) .datepicker-day__effect {\n        opacity: 1; }\n        .datepicker-days .datepicker-day.first .datepicker-day__effect:before, .datepicker-days .datepicker-day.select-start:hover:not(.selected) .datepicker-day__effect:before {\n          opacity: .5;\n          left: 50%; }\n      .datepicker-days .datepicker-day.last .datepicker-day__effect, .datepicker-days .datepicker-day.select-end:hover:not(.selected) .datepicker-day__effect {\n        opacity: 1; }\n        .datepicker-days .datepicker-day.last .datepicker-day__effect:before, .datepicker-days .datepicker-day.select-end:hover:not(.selected) .datepicker-day__effect:before {\n          opacity: .5;\n          left: -50%; }\n      .datepicker-days .datepicker-day.first.last .datepicker-day__effect:before {\n        opacity: 0; }\n      .datepicker-days .datepicker-day.disabled {\n        cursor: default;\n        color: rgba(0, 0, 0, 0.26); }\n        .datepicker-days .datepicker-day.disabled:hover .datepicker-day__effect,\n        .datepicker-days .datepicker-day.disabled:hover .datepicker-day__effect:before {\n          opacity: 0 !important; }\n    .datepicker-days .datepicker-day--current {\n      position: absolute;\n      top: 1px;\n      left: 50%;\n      transform: translateX(-50%);\n      width: 34px;\n      height: 34px;\n      border-radius: 50%;\n      border: 1px solid currentColor; }\n      @media only screen and (min-width: 768px) {\n        .datepicker-days .datepicker-day--current {\n          top: 4px;\n          width: 36px;\n          height: 36px; } }\n    .datepicker-days .datepicker-day__effect {\n      position: absolute;\n      top: 1px;\n      left: 50%;\n      width: 34px;\n      height: 34px;\n      border-radius: 50%;\n      transition: all 450ms cubic-bezier(0.23, 1, 0.32, 1);\n      transition-property: transform, opacity;\n      transform: translateX(-50%) scale(0); }\n      @media only screen and (min-width: 768px) {\n        .datepicker-days .datepicker-day__effect {\n          top: 4px;\n          width: 36px;\n          height: 36px; } }\n      .datepicker--range .datepicker-days .datepicker-day__effect:before {\n        content: \"\";\n        position: absolute;\n        top: 0;\n        left: 0;\n        width: 100%;\n        height: 100%;\n        background-color: inherit;\n        opacity: 0; }\n      .datepicker--range-selecting .datepicker-days .datepicker-day__effect {\n        transform: translateX(-50%) scale(0);\n        opacity: 0;\n        transition: none; }\n    .datepicker-days .datepicker-day__text {\n      position: relative;\n      vertical-align: sub; }\n\n.datepicker-transition-enter-active, .datepicker-transition-leave-active {\n  opacity: 1;\n  transition: all 300ms;\n  transition-property: transform, opacity;\n  transform: scale(1); }\n  @media only screen and (max-width: 479px) {\n    .datepicker-transition-enter-active.datepicker--fullscreen-mobile, .datepicker-transition-leave-active.datepicker--fullscreen-mobile {\n      transform: translateY(0); } }\n\n.datepicker-transition-leave-to, .datepicker-transition-enter {\n  opacity: 0;\n  transform: scale(0); }\n  @media only screen and (max-width: 479px) {\n    .datepicker-transition-leave-to.datepicker--fullscreen-mobile, .datepicker-transition-enter.datepicker--fullscreen-mobile {\n      transform: translateY(100%); } }\n\n/*# sourceMappingURL=DatePickerAgenda.vue.map */",null]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$8 = "data-v-ee5455a2";
    /* module identifier */
