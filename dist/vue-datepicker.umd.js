(function (global, factory) {
  ...
  __vue_render__$6._withStripped = true;
    ...
    const __vue_inject_styles__$6 = function (inject) {
      if (!inject) return
      inject("data-v-3f97ca4c_0", { source: "/*\n  Media Query mixin\n  @example scss\n\n  @include mq($from: mobile) {\n    color: red;\n  }\n  @include mq($to: tablet) {\n    color: blue;\n  }\n  @include mq(mobile, tablet) {\n    color: green;\n  }\n  @include mq($from: tablet, $and: '(orientation: landscape)') {\n    color: teal;\n  }\n*/\n.datepicker-preset[data-v-3f97ca4c] {\n  border: none;\n  margin: 0;\n  padding: 0;\n  width: auto;\n  overflow: visible;\n  background: transparent;\n  /* inherit font & color from ancestor */\n  color: inherit;\n  font: inherit;\n  /* Normalize `line-height`. Cannot be changed from `normal` in Firefox 4+. */\n  line-height: normal;\n  /* Corrects font smoothing for webkit */\n  -webkit-font-smoothing: inherit;\n  -moz-osx-font-smoothing: inherit;\n  /* Corrects inability to style clickable `input` types in iOS */\n  -webkit-appearance: none;\n}\n.datepicker-preset[data-v-3f97ca4c]:focus, .datepicker-preset[data-v-3f97ca4c]:active {\n    outline: 0;\n    box-shadow: 0;\n}\n.datepicker-preset[type=\"button\"][data-v-3f97ca4c], .datepicker-preset[type=\"reset\"][data-v-3f97ca4c], .datepicker-preset[type=\"submit\"][data-v-3f97ca4c], .datepicker-preset[role=\"button\"][data-v-3f97ca4c] {\n    cursor: pointer;\n}\n.datepicker-presets[data-v-3f97ca4c] {\n  position: relative;\n  display: flex;\n  padding: 16px 24px;\n}\n@media only screen and (min-width: 480px) {\n.datepicker-presets[data-v-3f97ca4c] {\n      padding: 16px 16px 8px;\n}\n}\n.datepicker-presets__wrapper[data-v-3f97ca4c] {\n    position: relative;\n    display: grid;\n    grid-template-columns: repeat(2, 1fr);\n    grid-auto-rows: 32px;\n    width: 100%;\n}\n@media only screen and (min-width: 768px) {\n.datepicker-presets__wrapper[data-v-3f97ca4c] {\n        grid-auto-rows: 32px;\n}\n}\n.datepicker-preset[data-v-3f97ca4c] {\n  position: relative;\n  padding: 0 8px;\n  transition: opacity 450ms cubic-bezier(0.23, 1, 0.32, 1);\n  font-size: 14px;\n  line-height: 14px;\n  overflow: hidden;\n  border-color: #eef1f8;\n  border-style: solid;\n  border-width: 0;\n}\n.datepicker-preset[data-v-3f97ca4c]:nth-child(odd) {\n    border-width: 0 1px 1px 1px;\n}\n.datepicker-preset[data-v-3f97ca4c]:nth-child(odd):first-child {\n      border-width: 1px;\n}\n.datepicker-preset[data-v-3f97ca4c]:nth-child(even) {\n    border-width: 0 1px 1px 0;\n}\n.datepicker-preset[data-v-3f97ca4c]:nth-child(even):nth-child(2) {\n      border-width: 1px 1px 1px 0;\n}\n.datepicker-preset__effect[data-v-3f97ca4c] {\n    position: absolute;\n    top: 0;\n    left: 0;\n    right: 0;\n    bottom: 0;\n    opacity: 0;\n    transition: opacity 450ms cubic-bezier(0.23, 1, 0.32, 1);\n    z-index: -1;\n}\n.datepicker-preset[data-v-3f97ca4c]:hover:not(.datepicker-preset--disabled) {\n    color: white;\n}\n.datepicker-preset:hover:not(.datepicker-preset--disabled) .datepicker-preset__effect[data-v-3f97ca4c] {\n      opacity: 1;\n}\n.datepicker-preset--selected[data-v-3f97ca4c] {\n    color: white;\n}\n.datepicker-preset--selected .datepicker-preset__effect[data-v-3f97ca4c] {\n      opacity: 1;\n}\n.datepicker-preset--disabled[data-v-3f97ca4c] {\n    color: rgba(93, 106, 137, 0.2);\n    cursor: not-allowed;\n    pointer-events: none;\n}\n\n/*# sourceMappingURL=DatePickerPresets.vue.map */", map: {"version":3,"sources":["DatePickerPresets.vue","/Users/stan/Web/Github/vue-datepicker/src/components/datepicker/DatePickerPresets.vue"],"names":[],"mappings":"AAAA;;;;;;;;;;;;;;;;CAgBC;AC4ED;EACA,YAAA;EACA,SAAA;EACA,UAAA;EACA,WAAA;ED1EE,iBAAiB;EC6EnB,uBAAA;EAEA,uCAAA;EACA,cAAA;ED5EE,aAAa;EC+Ef,4EAAA;EACA,mBAAA;EAEA,uCAAA;EACA,+BAAA;EACA,gCAAA;EAEA,+DAAA;EACA,wBAAA;AAAA;AATA;IAaA,UAAA;IACA,aAAA;AAAA;AAdA;IAqBA,eAAA;AAAA;AA3CA;EACA,kBAAA;EACA,aAAA;EACA,kBAAA;AAAA;ADzCE;ACsCF;MAMA,sBAAA;AAAA;AAcA;AAXA;IACA,kBAAA;IACA,aAAA;IACA,qCAAA;IACA,oBAAA;IACA,WAAA;AAAA;AD3CI;ACsCJ;QAQA,oBAAA;AAAA;AAEA;AAGA;EACA,kBAAA;EAEA,cAAA;EACA,wDAAA;EACA,eAAA;EACA,iBAAA;EACA,gBAAA;EACA,qBAAA;EACA,mBAAA;EACA,eAAA;AAAA;AAVA;IAgBA,2BAAA;AAAA;AAhBA;MAcA,iBAAA;AAAA;AAdA;IAsBA,yBAAA;AAAA;AAtBA;MAoBA,2BAAA;AAAA;AAKA;IACA,kBAAA;IACA,MAAA;IACA,OAAA;IACA,QAAA;IACA,SAAA;IACA,UAAA;IACA,wDAAA;IACA,WAAA;AAAA;AAjCA;IAqCA,YAAA;AAAA;AArCA;MAwCA,UAAA;AAAA;AAIA;IACA,YAAA;AAAA;AADA;MAIA,UAAA;AAAA;AAZA;IAiBA,8BAAA;IACA,mBAAA;IACA,oBAAA;AAAA;;AD9DA,gDAAgD","file":"DatePickerPresets.vue","sourcesContent":["/*\n  Media Query mixin\n  @example scss\n\n  @include mq($from: mobile) {\n    color: red;\n  }\n  @include mq($to: tablet) {\n    color: blue;\n  }\n  @include mq(mobile, tablet) {\n    color: green;\n  }\n  @include mq($from: tablet, $and: '(orientation: landscape)') {\n    color: teal;\n  }\n*/\n.datepicker-preset {\n  border: none;\n  margin: 0;\n  padding: 0;\n  width: auto;\n  overflow: visible;\n  background: transparent;\n  /* inherit font & color from ancestor */\n  color: inherit;\n  font: inherit;\n  /* Normalize `line-height`. Cannot be changed from `normal` in Firefox 4+. */\n  line-height: normal;\n  /* Corrects font smoothing for webkit */\n  -webkit-font-smoothing: inherit;\n  -moz-osx-font-smoothing: inherit;\n  /* Corrects inability to style clickable `input` types in iOS */\n  -webkit-appearance: none; }\n  .datepicker-preset:focus, .datepicker-preset:active {\n    outline: 0;\n    box-shadow: 0; }\n  .datepicker-preset[type=\"button\"], .datepicker-preset[type=\"reset\"], .datepicker-preset[type=\"submit\"], .datepicker-preset[role=\"button\"] {\n    cursor: pointer; }\n\n.datepicker-presets {\n  position: relative;\n  display: flex;\n  padding: 16px 24px; }\n  @media only screen and (min-width: 480px) {\n    .datepicker-presets {\n      padding: 16px 16px 8px; } }\n  .datepicker-presets__wrapper {\n    position: relative;\n    display: grid;\n    grid-template-columns: repeat(2, 1fr);\n    grid-auto-rows: 32px;\n    width: 100%; }\n    @media only screen and (min-width: 768px) {\n      .datepicker-presets__wrapper {\n        grid-auto-rows: 32px; } }\n\n.datepicker-preset {\n  position: relative;\n  padding: 0 8px;\n  transition: opacity 450ms cubic-bezier(0.23, 1, 0.32, 1);\n  font-size: 14px;\n  line-height: 14px;\n  overflow: hidden;\n  border-color: #eef1f8;\n  border-style: solid;\n  border-width: 0; }\n  .datepicker-preset:nth-child(odd) {\n    border-width: 0 1px 1px 1px; }\n    .datepicker-preset:nth-child(odd):first-child {\n      border-width: 1px; }\n  .datepicker-preset:nth-child(even) {\n    border-width: 0 1px 1px 0; }\n    .datepicker-preset:nth-child(even):nth-child(2) {\n      border-width: 1px 1px 1px 0; }\n  .datepicker-preset__effect {\n    position: absolute;\n    top: 0;\n    left: 0;\n    right: 0;\n    bottom: 0;\n    opacity: 0;\n    transition: opacity 450ms cubic-bezier(0.23, 1, 0.32, 1);\n    z-index: -1; }\n  .datepicker-preset:hover:not(.datepicker-preset--disabled) {\n    color: white; }\n    .datepicker-preset:hover:not(.datepicker-preset--disabled) .datepicker-preset__effect {\n      opacity: 1; }\n  .datepicker-preset--selected {\n    color: white; }\n    .datepicker-preset--selected .datepicker-preset__effect {\n      opacity: 1; }\n  .datepicker-preset--disabled {\n    color: rgba(93, 106, 137, 0.2);\n    cursor: not-allowed;\n    pointer-events: none; }\n\n/*# sourceMappingURL=DatePickerPresets.vue.map */",null]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$6 = "data-v-3f97ca4c";
    /* module identifier */
                ...
                directives: [
                  {
                    ...
                    expression:
                      "{ handler : () => $emit('resetDate'), isActive: !inline && isActive }"
                  }
                ],
                ref: "content",
